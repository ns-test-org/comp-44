      ...
      <div className="bg-gray-800 rounded-2xl shadow-2xl p-6 w-full max-w-sm">
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <button
            ...
            className="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-4 rounded-lg transition-colors"
          >
            7
          </button>
          <button
          ...
          <button
            ...
            className="row-span-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors"
          >
            =
          </button>
          ...
          <button
            ...
            className="col-span-2 bg-gray-600 hover:bg-gray-700 text-white font-semibold py-4 rounded-lg transition-colors"
          >
            0
          </button>
          <button
